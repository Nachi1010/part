    ...
    he: [
      {
        ...
        description: "הייטקיסטים מיומנים עם ניסיון מוכח יכולים להשלים הסבה ל-AI בתוך חודשים ספורים",
      ...
      {
        title: "להפוך למפתח AI אמיתי בתוך פחות משנה",
        description: "תוכנית ממוקדת ואינדיבידואלית שמקנה לכם את כל הידע והניסיון החסרים בלבד",
      ...
      {
        title: "AI: הייטק על סטרואידים. בואו לעבוד איתנו",
